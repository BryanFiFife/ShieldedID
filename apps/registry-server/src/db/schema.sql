...
CREATE TABLE IF NOT EXISTS audit_events (
  id INTEGER PRIMARY KEY AUTOINCREMENT,
  event_type TEXT NOT NULL CHECK (event_type IN ('WALLET_REGISTERED','KEY_ADDED','KEY_REVOKED','CREDENTIAL_REVOKED','WALLET_REVOKED','STATUS_CHECK','KEY_STATUS_CHECK','BACKUP_STORED','LOGIN_SUCCESS','LOGIN_FAILED','LOGOUT','CONTACT_RECEIVED','CONTACT_VIEWED','CONTACT_STATUS','USER_REGISTERED','USER_LOGIN')),
  wallet_id TEXT NULL,
  metadata TEXT NOT NULL CHECK (json_valid(metadata)),
  timestamp TEXT NOT NULL,
